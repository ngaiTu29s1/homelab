...
class BaseFeedGenerator:
    ...
    def add_pagination_links(self, feed, current_path, page, items_per_page, total_items, token=None):
        ...
        if page < total_pages:
            ...
            import re
            clean_path = re.sub(r'[?&](?:start_index|page)=\d+', '', current_path).rstrip('?&')
            has_clean_params = '?' in clean_path
            sep = '&' if has_clean_params else '?'
            ...
            next_link = {
                "link": {
                    "_attrs": {
                        ...
                        "title": "Next Page",
                        "type": "application/atom+xml;profile=opds-catalog",
                        "href": f"/opds/{clean_path}{sep}start_index={next_start_index}{auth_param}"
                    }
                }
            }
            ...
            prev_link = {
                "link": {
                    "_attrs": {
                        ...
                        "title": "Previous Page",
                        "type": "application/atom+xml;profile=opds-catalog",
                        "href": f"/opds/{clean_path}{sep}start_index={prev_start_index}{auth_param}"
                    }
                }
            }
